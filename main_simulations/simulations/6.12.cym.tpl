...
[[ myo_binding_rate = [3] ]]
[[ myo_unbinding_rate = [0.01, 0.1, 1, 10, 100, 1000, 10000, 100000] ]]
[[ myo_unbinding_force = [-0.01, -0.1, -1, -10, -100, -1000, 0] ]]
[[ myo_stall_force = [1000000] ]]
[[ myo_stiffness = [100] ]]
[[ myo_binding_range = [0.004] ]]
[[ myo_max_speed = [100] ]]
[[ bud_confine = [2, 20, 200, 2000] ]]
[[ myo_number = [50, 100, 200] ]]
[[ myo_z = [-0.392] ]]
...
set hand myosin
{
    binding_rate = [[ myo_binding_rate ]]
    binding_range = [[ myo_binding_range ]]
    unbinding_rate = [[ myo_unbinding_rate ]]
    unbinding_force = [[ myo_unbinding_force ]]

    activity = mighty
    max_speed = [[ myo_max_speed ]]
    stall_force = [[ myo_stall_force ]]
...
% 2 low, 20 phyiol , 200 high
    ...
    confine = first_surface, [[ bud_confine ]], insidecell
...
new [[ myo_number ]] single membrane_myosin
{
    %position = circle 0.0825 0 blur 0.01 at 0 0 -0.399
    %position = disc  0.12 0 at 0 0 -0.399
    position = disc  0.04 0 at 0 0 [[ myo_z ]] add circle 0.08 0
