...
for d in */ ; do
	...
	then
		...
		sed -i.tmp '
		/focus/ c\
		focus   = -0.000818 0.001905 -0.398781;
		' properties.cmo
		#rotation (larger sim)
		sed -i.tmp '
		/rotation/ c\
		rotation   = 0.715853 0.361394 0.268228 -0.533856;
		' properties.cmo
...
python ~/google_drive/grad_school/rotations/drubin/code/make_movie.py ~/google_drive/grad_school/rotations/drubin/code/cytosim_dblab/cytosim/bin/play lazy=0 $1/*output/*
